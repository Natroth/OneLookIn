...
class Message {
	...
	public function getConvos() {
		...
		foreach($convos as $username) {
			...
			$return_string .= "<a href='messages.php?u=$username'> <div class='user_found_messages'>
								...
								<span class='timestamp_smaller' id='gray'> &nbsp &nbsp &nbsp" . $latest_message_details[2] . "</span>
	...
	public function getConvosDropdown($data, $limit) {
		...
		foreach($convos as $username) {
			...
			$style = ($row['opened'] == 'no') ? "background-color: #f5f5f5;" : ""; 
...
"<h4><a href='messages.php?u=$username'>All Messages</h4>";
		...
		if($count > $limit)
			...
			$return_string .= "<input type='hidden' class='noMoreDropdownData' value='true'> <p style='text-align: center;'><a href='messages.php?u=$userLoggedIn' style='color: #13a380;'>All Messages</a></p>";
