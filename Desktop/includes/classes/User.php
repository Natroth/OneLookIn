...
class User {
	...
	public function getArtistId() {
		$username = $this->user['username'];
		$query = mysqli_query($this->con, "SELECT id FROM users WHERE username= '$username'");
		$row = mysqli_fetch_array($query);
		return $row['id'];
	} 	
	...
	public function getNumberFriendRequests() {
		...
		$username = $this->user['username'];
		$query = mysqli_query($this->con, "SELECT num_songs FROM users WHERE username= '$username'");
		$row = mysqli_fetch_array($query);
