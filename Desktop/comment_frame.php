<?php 
	...
	if (isset($_SESSION['username'])) {
	 ...
	 if(isset($_POST['postComment' . $post_id])) {
	 	...
	 	echo "<p style= background-color:#f5f5f5;margin-bottom:0;>
	 	 &nbsp &nbsp Comment Posted! </p>";
	}

	?>

	  <form action="comment_frame.php?post_id=<?php echo $post_id; ?>" id="comment_form" name="postComment<?php echo $post_id; ?>" method="POST" style="background-color: #f5f5f5; margin-bottom: 0">
	...
	if ($count != 0) {
		...
		while($comment = mysqli_fetch_array($get_comments)) {
			...
			<div class="comment_section" style="background-color: #ffffff">
		...
		echo "<center style=' position: relative; z-index: 10; top: 26%;'><br><br>Be the First to Comment!</center>";
	}
